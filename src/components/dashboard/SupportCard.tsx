      ...
      <div className="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 sm:p-6 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 transition-all duration-300 relative overflow-hidden group">
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h3 className="font-black text-sm sm:text-base uppercase tracking-widest text-slate-900 dark:text-slate-100">Help & Support</h3>
              <p className="text-[10px] sm:text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Availability: 24/7</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-slate-700 dark:text-slate-200">Email Support</span>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-black uppercase tracking-widest">Connect on WhatsApp</span>
              </div>
              <ExternalLink size={12} className="opacity-40 group-hover/btn:opacity-100 transition-all" />
            </motion.a>
          </div>
